...
echo "   - Run: git remote add origin https://github.com/YOUR_USERNAME/stock-management-app.git"
echo "   - Or if you already have a remote: git remote set-url origin https://github.com/YOUR_USERNAME/stock-management-app.git"
echo ""
